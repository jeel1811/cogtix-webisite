...
const CLIENT_LOGOS = [
  ...
  { name: "Pfizer", logo: "/clients/pfizer.svg" },
  { name: "Senior Care Finder", logo: "/clients/senior-care-finder.svg" },
  ...
  { name: "Market Force", logo: "/clients/market-force.jpg" },
...
export default function HappyClients() {
  ...
  return (
    <section className="py-10 bg-blue-50/60 border-y border-gray-100 overflow-hidden">
